...
function getSummaryInfo(){
		...
		$.ajax({
			...
			success : function(data){
				if(null != data && "" != data){
					...
					createUserRoomDataNew(data);
				}
			}
		});
	}
    //echarts
    function createUserRoomDataNew(data){
    	var chart = {
    		legend:['用户数', '下载数'],	
    		xAxis:[],
    		//用户数
		...
		$.ajax({
			...
			success : function(data){
				if(null != data && "" != data){
					...
					createCircularDataNew(datas,map);
				}
			}
		});
	}
    ...
    //echarts创建饼状图
	function createCircularDataNew(data,map){
		var chart = {
    		legend:[],	
    		dataset:[]
    	};
    ...
    //各项目下载情况数据处理
    function createChartDataNew(data){
    	var chart = {
    		legend:['总用户数', '下载用户数'],	
    		xAxis:[],
    		//总用户数
    	...
    	//绘制echarts图表
    	initItemDownEcharts(chart);
    }
	
    //各项目下载情况echarts
    function initItemDownEcharts(chart){
